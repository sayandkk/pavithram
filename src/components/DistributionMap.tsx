        ...
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground mb-8 leading-[1.1]">
              Serving the <span className="text-accent">Heart of Kerala</span>{" "}
              with Purity
            </h2>

            <p className="text-lg text-foreground/70 leading-relaxed mb-10 max-w-xl">
              From our central hub in Palakkad, Pavithram’s cold-chain logistics
              network spans across all 14 districts. We ensure that every home
              in God's Own Country has access to farm-fresh dairy excellence
              within hours.
            </p>
            ...
            <div className="flex items-center gap-4 p-6 rounded-3xl bg-secondary/5 border border-secondary/10">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Operating a robust network of 500+ distribution partners.
                </p>
              </div>
            </div>
          </motion.div>
